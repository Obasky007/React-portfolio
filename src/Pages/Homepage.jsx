        ...
        <div className="flex flex-col lg:flex-row sm:flex-row md:flex-row items-center gap-12 md:gap-20">
          <div className="flex-1 text-center md:text-left">
            ...
            >
              ...
              I'm a Front-End Developer who enjoys creating clean
              and easy-to-use websites. I like bringing ideas to life on the
              screen and I’m always learning new things to improve my work.
            </p>
          </div>
